...
export class IndexTs1708120638258 implements MigrationInterface {
  name = 'IndexTs1708120638258';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Doacoes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "pessoa_id" uuid NOT NULL, "local_id" uuid NOT NULL, "data" character varying NOT NULL, "create_at" character varying NOT NULL, "update_at" character varying NOT NULL, CONSTRAINT "PK_4249975758b6634b55b38ae91a7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "LocaisColeta" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying NOT NULL, "rua" character varying NOT NULL, "numero" character varying NOT NULL, "complemento" character varying NOT NULL, "cidade_id" uuid NOT NULL, "create_at" character varying NOT NULL, "update_at" character varying NOT NULL, CONSTRAINT "PK_59bc1d7639e77e66cf2e1fb0853" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "Cidades" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying NOT NULL, "estado_id" uuid NOT NULL, "create_at" character varying NOT NULL, "update_at" character varying NOT NULL, CONSTRAINT "PK_43f7f663a1febd06819da244150" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "Pessoas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying NOT NULL, "rua" character varying NOT NULL, "numero" character varying NOT NULL, "complemento" character varying NOT NULL, "rg" character varying NOT NULL, "cidade_id" uuid NOT NULL, "tipo_id" uuid NOT NULL, "create_at" character varying NOT NULL, "update_at" character varying NOT NULL, CONSTRAINT "PK_3e9888411f62082be12e16ed545" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Doacoes" ADD CONSTRAINT "FK_d96f3dc4887c7775db0367efb80" FOREIGN KEY ("pessoa_id") REFERENCES "Pessoas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Doacoes" DROP CONSTRAINT "FK_d96f3dc4887c7775db0367efb80"`,
    );
